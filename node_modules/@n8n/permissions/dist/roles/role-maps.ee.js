...
exports.ALL_ROLE_MAPS = exports.SECRETS_PROVIDER_CONNECTION_SHARING_SCOPE_MAP = exports.WORKFLOW_SHARING_SCOPE_MAP = exports.CREDENTIALS_SHARING_SCOPE_MAP = exports.PROJECT_SCOPE_MAP = exports.GLOBAL_SCOPE_MAP = void 0;
...
const secrets_provider_connection_sharing_scopes_ee_1 = require("./scopes/secrets-provider-connection-sharing-scopes.ee");
exports.GLOBAL_SCOPE_MAP = {
    ...
    'global:chatUser': global_scopes_ee_1.GLOBAL_CHAT_USER_SCOPES,
};
exports.PROJECT_SCOPE_MAP = {
    ...
    'project:chatUser': project_scopes_ee_1.PROJECT_CHAT_USER_SCOPES,
};
...
exports.SECRETS_PROVIDER_CONNECTION_SHARING_SCOPE_MAP = {
    'secretsProviderConnection:owner': secrets_provider_connection_sharing_scopes_ee_1.SECRETS_PROVIDER_CONNECTION_SHARING_OWNER_SCOPES,
    'secretsProviderConnection:user': secrets_provider_connection_sharing_scopes_ee_1.SECRETS_PROVIDER_CONNECTION_SHARING_USER_SCOPES,
};
exports.ALL_ROLE_MAPS = {
    ...
    secretsProviderConnection: exports.SECRETS_PROVIDER_CONNECTION_SHARING_SCOPE_MAP,
};
